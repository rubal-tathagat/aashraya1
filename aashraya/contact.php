      ...
      <div class="row">
        ...
        <div class="contact-form">
          <form action="contact_form.php" id="contact-form" method="POST">
            <h2>Send Message</h2>
            <div class="input-box">
                <input type="text" name="subject" required="true" name="">
                <span>Subject</span>
              </div>

            <div class="input-box">
              <input type="text" name="fullname" required="true" name="">
              <span>Full Name</span>
            </div>
            
            <div class="input-box">
              <input type="email" name="email" required="true" name="">
              <span>Email</span>
            </div>
            
            <div class="input-box">
              <textarea required="true" name="message" name=""></textarea>
              <span>Type your Message...</span>
            </div>
            <div class="mt-5">
                <input type="submit" name="submit" value="Send" class="learn-more-btn btn-header" href="#">
            </div>
