    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-sm-12 col-lg-6 text-center text-lg-start">
                <h2 class="free_title">Helpline for distressed strays who need medical assistance.</h2>
            </div>
            <div class="col-sm-12 col-lg-6 text-center text-lg-end mt-4 mt-lg-0"> 
                <a class="learn-more-btn" href="contact.php">Send Message</a> 
            </div>
        </div>
    </div>
</div>
